...
save(res, file = paste0("raw_results_sim_PLIV_", learner_name, "_n_", n_obs, "_p_", dim_x, ".Rda"))
...
ggsave(filename = paste0("densplot_PLIV_", n_obs, "_", dim_x, "_", 
...
fwrite(results_summary, file = paste0("results_PLIV_", n_obs, "_", dim_x, "_", 
